...
public class RobotMap {
	 ...
	 */ 
	public static WPI_TalonSRX TAL_gripMotorLeft = new WPI_TalonSRX(1);
	 ...
	 */
	public static WPI_TalonSRX TAL_elevatorMotor = new WPI_TalonSRX(19);
	//public static WPI_TalonSRX TAL_elevatorMotorSlave = new WPI_TalonSRX(18);
	public static WPI_TalonSRX TAL_carriageMotor = new WPI_TalonSRX(1);
